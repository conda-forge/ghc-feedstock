...
echo 'libraries/integer-gmp_CONFIGURE_OPTS = --ghc-options=" -lgmp -threaded -pgmc x86_64-conda_cos6-linux-gnu-cc -pgml x86_64-conda_cos6-linux-gnu-cc "' >> mk/build.mk
cat mk/build.mk
#./validate --build-only
echo "Settings"
cat settings
