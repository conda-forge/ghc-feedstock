...
export LDFLAGS+=" -L$PREFIX/lib -lgmp -lpthread -no_dtrace_dof"
...
echo "SRC_HC_OPTS = -O0 -H64m -optl-fuse-ld=gold -L$PREFIX/lib/gcc/x86_64-conda_cos6-linux-gnu/7.3.0 -L$PREFIX/lib -lgmp -threaded -lgcc -lgcc_s -pgmc $BUILD_PREFIX/bin/x86_64-conda_cos6-linux-gnu-cc -pgml $BUILD_PREFIX/bin/x86_64-conda_cos6-linux-gnu-cc " >> mk/build.mk
