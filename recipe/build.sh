...
if [ $ARCH == "64" ]; then
  ...
  echo $CC
  ./configure --prefix=$PREFIX --build=x86_64-unknown-linux --host=x86_64-unknown-linux --target=x86_64-unknown-linux CC=$BUILD_PREFIX/bin/x86_64-conda-linux-gnu-cc 
