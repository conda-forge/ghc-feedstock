...
echo "libraries/ghc-prim_dist-install_CPP_OPTS = -L$PREFIX/lib -lgmp -lpthread -lgcc -lgcc_s " >> mk/build.mk
...
echo "GhcRtsHcOpts= -optl -Wl,-L$PREFIX/lib  -optl -Wl,-L$PREFIX/lib/gcc/x86_64-conda_cos6-linux-gnu/7.3.0 -optl -Wl,-lgcc_s -optl -Wl,-lgcc  -pgmP x86_64-conda_cos6-linux-gnu-cpp -pgmc x86_64-conda_cos6-linux-gnu-cc -pgml x86_64-conda_cos6-linux-gnu-cc " >> mk/build.mk
cat mk/build.mk
#./validate --build-only
echo "Settings"
cat settings
