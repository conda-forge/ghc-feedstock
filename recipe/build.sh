...
export CONF_LD_LINKER_OPTS_STAGE0 =" -L$PREFIX/lib -lgmp -lpthread"
export CONF_LD_LINKER_OPTS_STAGE1 =" -L$PREFIX/lib -lgmp -lpthread"
export CONF_LD_LINKER_OPTS_STAGE2 =" -L$PREFIX/lib -lgmp -lpthread"
export CONF_LD_LINKER_OPTS_STAGE3 =" -L$PREFIX/lib -lgmp -lpthread"
