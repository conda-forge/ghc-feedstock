...
echo "libraries/ghc-prim/cbits/atomic_CC_OPTS += = -L$BUILD_PREFIX/lib/gcc/x86_64-conda_cos6-linux-gnu/7.3.0 -lgcc " >> mk/build.mk
#cat mk/build.mk
echo "config.mk"
cat mk/config.mk
perl -pi -e "s|LD_NO_GOLD = \$BUILD_PREFIX/bin/x86_64-conda_cos6-linux-gnu-cc|LD_NO_GOLD = $BUILD_PREFIX/bin/x86_64-conda_cos6-linux-gnu-ld|" mk/config.mk
