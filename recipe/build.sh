...
cat mk/config.mk.in
./configure --prefix=$PREFIX --with-gmp-includes=$PREFIX/include --with-gmp-libraries=$PREFIX/lib --with-gcc=$BUILD_PREFIX/x86_64-conda_cos6-linux-gnu-gcc --with-ld=$BUILD_PREFIX/x86_64-conda_cos6-linux-gnu-cc
cat mk/config.mk
