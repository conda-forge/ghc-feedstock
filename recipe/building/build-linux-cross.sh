...
run_and_log "stage1_ghc-bin" "${_hadrian_build[@]}" stage1:exe:ghc-bin --flavour=release+no_profiled_libs --docs=none --progress-info=none
...
run_and_log "stage1_lib" "${_hadrian_build[@]}" stage1:lib:ghc -VV --flavour=release+no_profiled_libs --docs=none --progress-info=none
update_linux_link_flags "${settings_file}"
...
run_and_log "stage2_ghc-bin" "${_hadrian_build[@]}" stage2:exe:ghc-bin --flavour=release+no_profiled_libs --docs=none --progress-info=none
run_and_log "stage2_ghc-pkg" "${_hadrian_build[@]}" stage2:exe:ghc-pkg --flavour=release+no_profiled_libs --docs=none --progress-info=none
run_and_log "stage2_hsc2hs" "${_hadrian_build[@]}" stage2:exe:hsc2hs --flavour=release+no_profiled_libs --docs=none --progress-info=none
