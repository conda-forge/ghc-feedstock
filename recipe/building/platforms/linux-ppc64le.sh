...
# ==============================================================================
# GHC cross-compilation for Linux ppc64le (build on x86_64, target ppc64le)
# Uses libc 2.17 sysroot for maximum compatibility
#
# Build Strategy:
# - Stage 1: Build cross-compiler using x86_64 bootstrap GHC
# - Stage 2: Use Stage 1 to build ppc64le-targeted binaries
...
platform_setup_environment() {
  echo "  Setting up Linux ppc64le cross-compilation environment..."
  ...
  echo "  ✓ Linux ppc64le cross-compilation environment ready"
}
...
platform_configure_ghc() {
  echo "  Configuring GHC for ppc64le cross-compilation..."
