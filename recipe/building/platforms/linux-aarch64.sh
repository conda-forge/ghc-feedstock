...
# ==============================================================================
# GHC cross-compilation for Linux aarch64 (build on x86_64, target aarch64)
# Uses libc 2.17 sysroot for maximum compatibility
#
# Build Strategy:
# - Stage 1: Build cross-compiler using x86_64 bootstrap GHC
# - Stage 2: Use Stage 1 to build aarch64-targeted binaries
...
platform_setup_environment() {
  echo "  Setting up Linux aarch64 cross-compilation environment..."
  ...
  echo "  ✓ Linux aarch64 cross-compilation environment ready"
}
...
platform_configure_ghc() {
  echo "  Configuring GHC for aarch64 cross-compilation..."
