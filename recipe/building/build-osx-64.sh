...
# perl -i -pe "s#(C compiler link flags\", \")([^\"]*)#\1\2 -lto_library \\\$topdir/../../../lib/libLTO.dylib -Wl,-L\\\$topdir/../../../../lib -Wl,-rpath,\\\$topdir/../../../../lib ${iconv_aliases} -liconv#" "${settings_file}"
# perl -i -pe "s#(ld flags\", \")([^\"]*)#\1\2 -lto_library \\\$topdir/../../../lib/libLTO.dylib -L\\\$topdir/../../../../lib ${iconv_aliases} -liconv#" "${settings_file}"
perl -i -pe "s#(C compiler link flags\", \")([^\"]*)#\1\2 -lto_library @rpath/libLTO.dylib -Wl,-L\\\$topdir/../../../../lib -Wl,-rpath,\\\$topdir/../../../../lib ${iconv_aliases} -liconv#" "${settings_file}"
