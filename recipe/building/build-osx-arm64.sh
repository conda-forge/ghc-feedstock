...
"${SRC_DIR}"/_build/stage0/bin/arm64-apple-darwin-ghc --version
...
run_and_log "install_xcompiled" "${_hadrian_build[@]}" install --prefix="${PREFIX}" --flavour=release --freeze1 --freeze2 --docs=no-sphinx-pdfs
