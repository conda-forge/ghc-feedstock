...
# -D_VA_LIST: Tell MinGW's vadefs.h that va_list support is available (Clang builtin)
...
export CFLAGS="-fms-extensions -fms-compatibility -D__MINGW32__ -D_VA_LIST -Dva_list=__builtin_va_list -isystem ${CLANG_BUILTIN_INCLUDE} -isystem ${_BUILD_PREFIX}/Library/include -isystem ${MINGW_SYSROOT}/usr/include ${CFLAGS:-}"
export CXXFLAGS="-fms-extensions -fms-compatibility -D__MINGW32__ -D_VA_LIST -Dva_list=__builtin_va_list -isystem ${CLANG_BUILTIN_INCLUDE} -isystem ${_BUILD_PREFIX}/Library/include -isystem ${MINGW_SYSROOT}/usr/include ${CXXFLAGS:-}"
