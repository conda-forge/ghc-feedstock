...
UCRT_INCLUDE=$(find /c/Program Files*x86*/Windows*/10/Include/${SDK_VERSION} -type d -name ucrt | head -1)
UM_INCLUDE=$(find /c/Program Files*x86*/Windows*/10/Include/${SDK_VERSION} -type d -name um | head -1)
SHARED_INCLUDE=$(find /c/Program Files*x86*/Windows*/10/Include/${SDK_VERSION} -type d -name shared | head -1)
UM_LIB=$(find /c/Program Files*x86*/Windows*/10/Lib/${SDK_VERSION}/um -type d -name x64 | head -1)
