...
export CFLAGS="-I${BUILD_PREFIX}/Library/include -I/C/Program Files \(x86\)/Windows Kits/10/Include/10.0.26100.0/ucrt -I${BUILD_PREFIX}/Library/x86_64-w64-mingw32/sysroot/usr/include ${CFLAGS:-}"
