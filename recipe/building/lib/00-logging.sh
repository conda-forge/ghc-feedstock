#!/usr/bin/env bash
# ==============================================================================
# GHC Conda-Forge Build: Logging Module
# ==============================================================================
# Purpose: Command execution with logging and progress reporting
#
# Functions:
#   run_and_log(name, command...) - Execute command with log capture
#
# Dependencies: None (foundational module)
#
# Usage:
#   source lib/00-logging.sh
#   run_and_log "configure" bash configure --prefix=/opt
# ==============================================================================
