...
// Timezone stubs for UCRT compatibility
// The bootstrap GHC's time library references __imp__timezone and __imp__tzname
// which are MSVCRT symbols not available in UCRT. Provide stubs.
//
...
long _timezone_data = 0;  // UTC offset in seconds (0 = UTC)
char _tzname_std[] = "UTC";
char _tzname_dst[] = "UTC";
char *_tzname_data[2] = { _tzname_std, _tzname_dst };
