/* MinGW32 UCRT Timezone Compatibility Stubs
 *
 ...
 *
 * IMPORTANT: This library ONLY provides timezone symbols.
 * Do NOT add runtime initialization stubs (__main, TLS, etc.) here -
 * those must come from the normal MinGW CRT to avoid breaking pure C programs
 * like hsc2hs-generated test executables.
 */
